...
class TaxiKartaContinuePracticeScreen extends StatefulWidget {
  const TaxiKartaContinuePracticeScreen({super.key, required this.practiceSet});

  final int practiceSet;

  @override
  State<TaxiKartaContinuePracticeScreen> createState() => _TaxiKartaContinuePracticeScreenState();
}

class _TaxiKartaContinuePracticeScreenState extends State<TaxiKartaContinuePracticeScreen> {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<int>(
      valueListenable: KartaPracticeRepository.instance.progressRevision,
      builder: (context, _, __) {
        ...
        if (total == 0) {
          WidgetsBinding.instance.addPostFrameCallback((_) {
            if (context.mounted) context.go('/taxi-karta');
          });
          return const Scaffold(
            body: Center(child: CircularProgressIndicator()),
          );
        ...
        final resumeUri = '/taxi-question?module=karta&practiceSet=$practiceSet&q=$nq';
  ...
  static String _dominantThemeLabel(List<TaxiPracticeQuestion> partition) {
    if (partition.isEmpty) return 'Övningsfrågor — taxi karta';
    ...
    if (counts.isEmpty) return 'Övningsfrågor — taxi karta';
        ...
        children: [
          ...
          GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final uri = '/taxi-question?module=karta&practiceSet=$practiceSet&q=$i';
