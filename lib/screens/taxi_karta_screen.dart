...
class TaxiKartaScreen extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Öva på ruttplanering, hitta rätt i staden och förstå kartans alla detaljer för att klara taxiprovet.',
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Många frågor testar din förmåga att välja den mest tidseffektiva rutten under olika trafikförhållanden. Var uppmärksam på enkelriktade gator och miljözoner.',
                            style: GoogleFonts.inter(
                              fontSize: 12,
              ...
              _buildSetCard(
                context,
                title: 'Set 1',
                questionsRange: 'Frågor 1–45',
                statusTopRight: '88% Resultat',
                progress: 1.0,
              ...
              _buildSetCard(
                context,
                title: 'Set 2',
                questionsRange: 'Frågor 46–90',
                statusTopRight: '12 / 45',
                progress: 12 / 45,
  ...
  Widget _buildNavItem(BuildContext context, IconData icon, String label, int index, String route) {
    final isSelected = index == 1; // Karta is active
    return GestureDetector(
